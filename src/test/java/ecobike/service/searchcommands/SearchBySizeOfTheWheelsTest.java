...
class SearchBySizeOfTheWheelsTest {
    private static SearchBySizeOfTheWheels predicate;
    ...
    static void start() {
        ...
        predicate = context.getBean(SearchBySizeOfTheWheels.class);
    }
